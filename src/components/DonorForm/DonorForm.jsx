...
export default function DonorForm({ user }) {
    ...
    return (
        <div className="container">
            <h1 className="text-center text-xl mb-2 font-bold text-purple-900">Update Donor's Info</h1>
            <form onSubmit={(evt) => {
                handleSubmit(evt);
                navigateToProfile()
                }}>
            ...
            <button  className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">Submit Donor's Update</button>
            </form>
